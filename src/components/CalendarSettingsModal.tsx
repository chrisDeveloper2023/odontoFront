...
const coloresDisponibles = [
  ...
  { nombre: "Índigo", valor: "bg-indigo-500", hex: "#6366f1" },
...
const CalendarSettingsModal: React.FC<CalendarSettingsModalProps> = ({
  ...
  // Cargar doctores y sincronizar con odontólogos configurados
  useEffect(() => {
    const cargarDoctores = async () => {
      ...
      try {
        ...
        // Sincronizar con los odontólogos configurados
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md bg-slate-800 border-slate-700">
        ...
        <div className="space-y-6">
          ...
          {/* Lista de odontólogos con selectores de color */}
