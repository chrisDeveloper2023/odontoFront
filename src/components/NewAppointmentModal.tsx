...
interface NewAppointmentModalProps {
  ...
  const handleOdontologoChange = (doctorId: string) => {
    ...
    if (doctor) {
      ...
      // Buscar el color correspondiente en los odontólogos configurados
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="odontologo">Médico *</Label>
                <Select 
                ...
                >
                  <SelectTrigger>
                    <SelectValue placeholder={loadingDoctores ? "Cargando médicos..." : "Seleccionar médico"} />
                  </SelectTrigger>
                  <SelectContent>
                    {doctores.map((doctor) => {
                      const nombreCompleto = `${doctor.nombres} ${doctor.apellidos}`;
